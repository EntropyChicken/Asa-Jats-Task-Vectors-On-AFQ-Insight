...
# Define custom function for first tract extraction
...
try:
    ...
    try:
        x_sample, labels_sample = next(iter(first_tract_train_loader))
    ...
    train_loader_raw = RemappedDataLoader(first_tract_train_loader)
    test_loader_raw = RemappedDataLoader(first_tract_test_loader)
    val_loader_raw = RemappedDataLoader(first_tract_val_loader)
    
    # ================================================================================
    # STAGED TRAINING EXPERIMENT
    # ================================================================================
    print("\n\n" + "="*80)
    print("RUNNING STAGED TRAINING EXPERIMENT - FIRST TRACT ONLY")
    print("="*80 + "\n")
    sys.stdout.flush()
    ...
    staged_save_directory = "first_tract_experiment_results"
    ...
    print("\n" + "="*80)
    print("First tract staged training experiment complete!")
    print("="*80 + "\n")
except Exception as e:
